  ...
  return (
    <div className="group bg-[#151B26] border border-[#1E2330] rounded-xl p-3 flex flex-col gap-3 hover:border-[#FFD70055] hover:bg-[#1A202E] transition-all cursor-pointer shadow-lg hover:-translate-y-1">
      ...
      <Link to={`/game/${game.id}`}>
        <button className="w-full bg-[#FFD700] text-[#05070A] py-2 rounded-lg text-[10px] font-extrabold uppercase tracking-wider hover:bg-[#FFE033] active:scale-95 transition-all shadow-[0_4px_10px_rgba(255,215,0,0.1)]">
          Quick Join
        </button>
      </Link>
    </div>
